...
public class RedoxiationConfigHandler {
	...
	public static void InitConfig(){
    	...
    	items.CopperIngot_enable = config.get(CATEGORY_ITEMS, "CopperIngot", true).getBoolean();
    	...
    	items.LeadIngot_enable = config.get(CATEGORY_ITEMS, "LeadIngot", true).getBoolean();
    	...
    	items.NickelIngot_enable = config.get(CATEGORY_ITEMS, "NickelIngot", true).getBoolean();
    	...
    	items.PlatinumIngot_enable = config.get(CATEGORY_ITEMS, "PlatinumIngot", true).getBoolean();
    	...
    	items.SilverIngot_enable = config.get(CATEGORY_ITEMS, "SilverIngot", true).getBoolean();
    	items.SilverNugget_enable = config.get(CATEGORY_ITEMS, "SiilverNugget", true).getBoolean();
    	items.SteelIngot_enable = config.get(CATEGORY_ITEMS, "SteelIngot", true).getBoolean();
    	...
    	items.TinIngot_enable = config.get(CATEGORY_ITEMS, "TinIngot", true).getBoolean();
    	...
    	items.TitaniumIngot_enable = config.get(CATEGORY_ITEMS, "TitaniumIngot", true).getBoolean();
    	...
    	items.TungstenIngot_enable = config.get(CATEGORY_ITEMS, "TungstenIngot", true).getBoolean();
    	...
    	items.ZincIngot_enable = config.get(CATEGORY_ITEMS, "ZincIngot", true).getBoolean();
